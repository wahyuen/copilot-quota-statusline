...
const DESCRIPTIONS = {
    ...
    quotaBarColor: "Quota (Q:) bar color",
    monthBarColor: "Month (M:) bar color",
    ...
    tools: [
        {
            ...
            description: "Show the current quota-statusline display settings — bar characters, colors, pace icons, and bar width. Shows which values are custom vs default, and includes hints for emoji options.",
